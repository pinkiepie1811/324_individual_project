...
ui =  navbarPage("Visualizations",
      ...
      tabPanel("Overview",
               ...
               h3("The goal of these graphs is to help scientists easily notice the trends and outliers in this dataset and, therefore, gain a direction for further investigation. The questions can be answered through these visualisations:."),
              ...
              h4("- Is there any segragation between samples of different age group?")),
