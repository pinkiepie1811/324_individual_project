...
ui =  navbarPage("Visualizations",
      ...
      tabPanel("Overview",
               h3("These visualizations are the summary of the gene expressions in the human brain's frontal cortex tissues. "),
               h3("The goal of these graphs is to help scientists easily notice the trends and outliers in this dataset and, therefore, gain a direction for further investigation."),
              h3("The questions can be answered through these visualisations:"),
              h4("- What are the demographics of the samples"),
              h4("- Solely based on expression levels, what are the correlations between the genes"),
              h4("- Is there any difference between male and female samples?"),
              h4("- Is there any segregation between samples of different age group?")),
...
0) Ventilator Case All cases on a ventilator immediately before death.")
    ...
    tabPanel("Age Groups",
             h4("Principal component analysis (PCA) reduces the dimensionality of multivariate data, 
                ...
                Overlapping confidence ellipses showed that there is little segregation between samples of different ages"),
             plotlyOutput("PCA"),
             h4("To hide/unhide a group, click on its icon on the right")
    )
  )
